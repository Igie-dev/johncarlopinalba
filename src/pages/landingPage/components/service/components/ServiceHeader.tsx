...
export default function ServiceHeader() {
	...
	return (
		<header
			...
			className="absolute flex flex-col items-center w-[97%] right-1/2 transform translate-x-1/2 gap-5 px-2 py-16 shadow-lg text-white rounded-md -top-32 bg-neutral/90 border-2 border-base-content max-w-[60rem]">
